...
cat_variables <- colnames(full_dat)[c(7:14, 16)]
...
prop_cat_variables <- colnames(prop_dat)[c(7:14, 16)]
...
prop_loi_cat_variables <- colnames(prop_loi_dat)[c(7:14, 16)]
